...
function Index(props) {
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])(react__WEBPACK_IMPORTED_MODULE_2__["Fragment"], {
    ...
    }), /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])(_components_meetups_MeetupList__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://harish:harish8249@cluster0.xacsm.mongodb.net/meetup?retryWrites=true&w=majority');
  const db = client.db();
  const meetupCollection = db.collection('meetup');
